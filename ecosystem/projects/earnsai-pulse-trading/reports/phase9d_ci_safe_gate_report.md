...
- Generated at: `2026-05-03T15:21:22.898710+00:00`
- Overall OK: `True`
...
{'ok': True, 'json_path': 'reports/phase8b_journal_analytics.json', 'markdown_path': 'reports/phase8b_journal_analytics.md', 'total_rows': 500, 'rates_pct': {'approved_paper_pct': 71.4, 'rejected_pct': 28.6, 'blocked_pct': 0.0, 'hold_pct': 28.6, 'buy_pct': 50.0, 'sell_pct': 21.4}}
make[2]: Leaving directory '/home/egitaristorandas/earnsai-pulse-trading'
make fixture-report
make[2]: Entering directory '/home/egitaristorandas/earnsai-pulse-trading'
...
PHASE9B_SMOKE PASS main_before=4508 main_after=4508 isolated_rows=2 report=reports/phase9b_journal_noise_report.md
make[1]: Leaving directory '/home/egitaristorandas/earnsai-pulse-trading'
```
...
PHASE9A_SMOKE PASS scenarios=4 bullish=BUY bearish=SELL flat=HOLD volatile=BUY
python3 scripts/phase9b_smoke.py
PHASE9B_SMOKE PASS main_before=4512 main_after=4512 isolated_rows=2 report=reports/phase9b_journal_noise_report.md
