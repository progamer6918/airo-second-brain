...
integration: EXACT
-->
- **NKTB_019**: Critical missing fields must not enter clean ledger/dashboard metrics.
<!-- AFPD_RULE_PROVENANCE
rule_id: NKTB_070
source_path: ecosystem/projects/vortex-ai-skill-lab/docs/AIRO_FINANCE_COMMAND_CENTER_FINAL_KITAB.md
source_line: 1063
integration: EXACT
-->
- **NKTB_070**: Cash Umum and Cash Bensin must be read from Account Ledger.
<!-- AFPD_RULE_PROVENANCE
rule_id: NARF_014
...
integration: EXACT
-->
- **NARF_014**: Transfer email transactions must ask source account and destination account, or fall back to Review Queue as `Transfer / Review` without direct ledger write.
<!-- AFPD_RULE_PROVENANCE
rule_id: NARF_028
source_path: ARFIN.md
source_line: 155
integration: EXACT
-->
- **NARF_028**: Approval must write ledger rows according to the stored posting plan.
<!-- AFPD_RULE_PROVENANCE
rule_id: NARF_033
source_path: ARFIN.md
source_line: 190
integration: EXACT
-->
- **NARF_033**: Account Ledger must reflect real balance movement.
