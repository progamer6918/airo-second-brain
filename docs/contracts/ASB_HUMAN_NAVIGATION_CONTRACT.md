...
7. **Rich Work History**: Root Home embeds dynamic Obsidian Base `![[worklog/views/AIRO Worklog.base#Hari Ini]]`, and global `RIWAYAT_KERJA.md` embeds full session history.
