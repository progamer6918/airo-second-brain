...
| POLREG geographic market drill-down | POLREG_2026_AREA_HIERARCHY.tsv & POLREG_YTD_JUN_2026_GEOGRAPHY_SEGMENT.tsv (POLREG 2026 aggregate) | YTD Jan-Jun 2026 | Current deep-geography authority for segment-filtered Kabupaten/Kecamatan/Kelurahan-Desa retrieval. Upstream lineage originates from POLREG PER KECAMATAN PER KELURAHAN PER SEGMENT 2026.xlsx (Data + 9 geography sheets). Preserve source-specific classification differences vs dedicated M/S workbook. |
...
| AIRO Commercial Copilot delivery & interaction classification | AIRO_COMMERCIAL_COPILOT_V1.md / AIRO_COPILOT_ACTION_TRACKER.tsv | 2024-2026 | User-facing delivery and interaction layer orchestrating 11 underlying intelligence engines into role-tailored briefs, chat intent routing, and PICA action tracking. |
