...
| **AIRO Finance / vortex-ai-skill-lab** | `ACTIVE` | Pending project reconciliation | `CURRENT.md` + `AIRO_FINANCE_PRD_LIVING.md` + latest validation/runtime evidence | Old canonical roadmap lock vs Task/Gate taxonomy must be reconciled in a later phase. Do not resolve in this gate. |
