...
| **AIRO Finance / vortex-ai-skill-lab** | `ACTIVE` | `ecosystem/projects/vortex-ai-skill-lab/docs/plans/AIRO_FINANCE_WEB_APP_V2_EXECUTION_SLICE_PLAN.md` | AFPD current handoff + Web App V2 PRD addendum + latest runtime evidence | Owner-approved Web App V2 track (Phases 0–8). Read-only cockpit architecture. |
