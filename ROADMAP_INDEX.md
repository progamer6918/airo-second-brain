...
|---|---|---|---|---|
| **ASB_GLOBAL** | `ACTIVE` | `docs/roadmap/AIRO_SECOND_BRAIN_v0.6_ROADMAP.md` | `docs/roadmap/AIRO_SECOND_BRAIN_v0.6_MILESTONE_TRACKER.tsv` | ASB v0.6 7-Milestone Roadmap. Active milestone: M4 — LLM Wiki Memory Loop (Status: NOT_YET_PROVEN). Previous: M3 (DONE). See [Design Spec](docs/specs/asb/AIRO_SECOND_BRAIN_v0.6_DESIGN_SPEC.md). |
