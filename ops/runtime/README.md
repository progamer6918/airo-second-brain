...
- **Windows Integration**: 
  - `AIRO-SecondBrain-Sync.ps1`: The target script for Task Scheduler (invoked silently).
  - `AIRO-SecondBrain-InstallTask.ps1`: Automated installer to register the task running windowlessly (runs every 5 minutes and at logon).
