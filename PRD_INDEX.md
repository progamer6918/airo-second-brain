...
|---|---|---|---|
| **ASB_GLOBAL** | `docs/prd/AIRO_SECOND_BRAIN_PRD_v0.5.1.md` | `ACTIVE_CANONICAL` | Primary active canonical spec for the ASB kernel. |
| **ASB_GLOBAL** | `docs/AIRO_SECOND_BRAIN_PRD_v0.4.1_NO_BRAINER.md` | `SUPERSEDED_ARCHIVE_REFERENCE` | Legacy spec, superseded by v0.5.1. |
| **AIRO Finance / vortex-ai-skill-lab** | `ecosystem/projects/vortex-ai-skill-lab/docs/AIRO_FINANCE_WEB_APP_V2_PRD_ADDENDUM.md` | `OWNER_APPROVED_ACTIVE_PROJECT_ADDENDUM` | Owner-approved Web App V2 read-only cockpit addendum. Preserves AIRO_FINANCE_PRD_LIVING.md as active reference candidate. |
...
| **D-READY** | `ecosystem/projects/d-ready/D_READY_PRD_LIVING.md` | `ACTIVE_REFERENCE_CANDIDATE` | Public-safe project contract. Excel logic prototype with Power BI target architecture; critical business rules remain pending. |
