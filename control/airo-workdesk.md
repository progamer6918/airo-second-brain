...
- `HOME_V2_LIVE_CURRENT_WORK_BRIDGE=IMPLEMENTED (Superseded by WORKDESK.md)`
...
# Permanent Owner Acceptance Guardrails
WORKDESK_OWNER_SURFACE_PATH=wiki/workdesk/WORKDESK.md
WORKDESK_OWNER_SURFACE_ACCEPTED=YES
WORKDESK_LIVE_CURRENT_WORK_BRIDGE=IMPLEMENTED
OWNER_RENDERED_SEMANTIC_AUDIT_REQUIRED=YES
EXECUTOR_RECEIPT_ALONE_SUFFICIENT=NO
CLAIM_VS_CONTENT_QA_REQUIRED=YES
OWNER_TASK_SIMULATION_REQUIRED=YES
VISIBLE_BACKEND_PATHS_IN_PRIMARY_OWNER_NAV=FORBIDDEN
